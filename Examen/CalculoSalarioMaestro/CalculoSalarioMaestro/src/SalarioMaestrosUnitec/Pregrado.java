 ...
 * @author Deyvi Tabora
 */
public class Pregrado extends Profesor{
    ...
    public Pregrado(String nombre, String Ncuenta, double pagoXClase) {
        super(nombre, Ncuenta);
        this.pagoXClase = pagoXClase;
    }

    public double getPagoXClase() {
        return pagoXClase;
    }

    public void setPagoXClase(double pagoXClase) {
        this.pagoXClase = pagoXClase;
    }
